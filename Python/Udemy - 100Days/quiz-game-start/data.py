...
# api data url https://opentdb.com/api.php?amount=50&category=18&difficulty=hard&type=boolean
# url analyze https://opentdb.com/ api.php?  amount=50 & category=18 & difficulty=hard & type=boolean
